                        ...
                        <?php
                            if(isset($_POST['type'])){
                                ...
                                if($type=="Project"){
                                    ...
                                    $result=mysqli_query($con,'select count(project_id) as total from projects where user_id='.$login_session);
                                    ...
                                    echo '
                                            ...
                                            <div class="navigate" style="width:100%; height:35px; margin-top:1%; display:none;">
                                             ...
                                             function loaddata(count){
                                                ...
                                                $.ajax({
                                                    ...
                                                    if(obj[i]['abstract'].length>70)
                                                        ...
                                                        if(i%2==0)
                                                            $(\"<tr onclick='referto(\"+obj[i]['question_id']+\");' data=\"+obj[i]['question_id']+\" style=' cursor:pointer; height: 25px; background-color:#3bb998; border-bottom:1px solid grey;'><td>\"+obj[i]['answer_id']+\"</td><td>\"+obj[i]['abstract']+\"</td></tr>\").appendTo('tbody');
                                                        else
                                                            $(\"<tr onclick='referto(\"+obj[i]['question_id']+\");' data=\"+obj[i]['question_id']+\" style=' cursor:pointer; height: 25px; background-color:#399bb8;'><td>\"+obj[i]['answer_id']+\"</td><td>\"+obj[i]['abstract']+\"</td></tr>\").appendTo('tbody');
                                                    });
                                    ...
                                    echo '
                                        <div style="border-top-left-radius:10px; border-top-right-radius:10px; margin-top:1%; overflow:hidden;">
                                            ...
                                            ';
                                    include './include/connection.php';
                                    $result=mysqli_query($con,'select count(answer_id) as total from answers where user_id='.$login_session);
                                    $row=mysqli_fetch_array($result);
                                    $total=ceil($row['total']/10);
                                    if($total==0)
                                        $count=0;
                                ...
                                if($type=="Question"){
                                    echo "
                                        <script>
                                             ...
                                             function loaddata(count){
                                                ...
                                                $.ajax({
                                                    ...
                                                    if(obj[i]['title'].length>70)
                                                        ...
                                                        if(i%2==0)
                                                            $(\"<tr onclick='referto(\"+obj[i]['question_id']+\");' data=\"+obj[i]['question_id']+\" style=' cursor:pointer; height: 25px; background-color:#3bb998; border-bottom:1px solid grey;'><td>\"+obj[i]['question_id']+\"</td><td>\"+obj[i]['title']+\"</td></tr>\").appendTo('tbody');
                                                        else
                                                            $(\"<tr onclick='referto(\"+obj[i]['question_id']+\");' data=\"+obj[i]['question_id']+\" style=' cursor:pointer; height: 25px; background-color:#399bb8;'><td>\"+obj[i]['question_id']+\"</td><td>\"+obj[i]['title']+\"</td></tr>\").appendTo('tbody');
                                                    });
                                            ...
                                            function referto(link){
                                                window.location.href='view_question.php?question_id='+link;
                                            }
                                        </script>
                                    ";
                                    echo '
                                        <div style="border-top-left-radius:10px; border-top-right-radius:10px; margin-top:1%; overflow:hidden;">
                                            <table  style=" border-collapse:collapse; width:100%;">
                                                <thead class="tablehead">
                                                    <tr style="background-color:#4695c0; color:white; height: 35px; "><th>Question Id</th><th style="width:65%">Title</th></tr>
                                                </thead>
                                                <tbody id="tbody">
                                            ';
                                    include './include/connection.php';
                                    $result=mysqli_query($con,'select count(question_id) as total from questions where user_id='.$login_session);
                                    $row=mysqli_fetch_array($result);
                                    $total=ceil($row['total']/10);
                                    if($total==0)
                                        $count=0;
